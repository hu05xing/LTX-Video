...
class BasicTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        if self.adaptive_norm in ["single_scale_shift", "single_scale"]:
            ...
            logger.error(f"❌ Unknown adaptive norm type: {self.adaptive_norm}") 
...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        if qk_norm is None:
            ...
            logger.error(f"❌ Unsupported qk_norm method: {qk_norm}") 
        ...
        if cross_attention_norm is None:
            ...
            logger.error(f"❌ unknown cross_attention_norm: {cross_attention_norm}") 
            raise ValueError(
